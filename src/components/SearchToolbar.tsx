        ...
        <div className="grid gap-3 xl:grid-cols-3">
          <div className="relative xl:col-span-2">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-2.5 pl-11 pr-4 text-sm text-slate-800 outline-none transition focus:border-slate-900 focus:bg-white"
            />
          </div>

          <button
            onClick={onOpenCatalog}
            className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-800 transition hover:border-slate-950"
          >
          ...
          <div className="grid gap-3 sm:grid-cols-2 xl:col-span-3 xl:grid-cols-4">
            ...
            <button
              onClick={onCreateNew}
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#b791d0] px-4 py-2.5 text-sm font-semibold text-[#2d0140] transition hover:bg-[#a97dc8]"
            >
